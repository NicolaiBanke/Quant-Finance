...
double N_1(const double &x) {
  ...
  const std::vector<double> a = {2.50662823884, -18.61500062529, 41.39119773534,
                                 -25.44106049637};

  const std::vector<double> b = {-8.47351093090, 23.08336743743, 21.06224101826,
                                 3.13082909833};
